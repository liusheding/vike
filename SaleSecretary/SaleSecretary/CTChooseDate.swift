...
//  SaleSecretary
//
//  Created by Lutiguang on 2017/9/22.
...
class CTChooseDate: UIView {

    fileprivate var contentHeight:CGFloat = 230
...
extension CTChooseDate : UITableViewDelegate,UITableViewDataSource{
